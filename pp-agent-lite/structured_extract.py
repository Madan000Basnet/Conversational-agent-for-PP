    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "profit":    {"type":"object","additionalProperties":{"type":"number"}},
                "usage":     {"type":"object","additionalProperties":{
                                  "type":"object","additionalProperties":{"type":"number"}}},
                "capacity":  {"type":"object","additionalProperties":{
                                  "type":"object","additionalProperties":{"type":"number"}}},

                "demand":        {"type":"object","additionalProperties":{
                                      "type":"object","additionalProperties":{"type":"number"}}},
                "allow_backlog": {"type":"boolean"},
                "max_batches":   {"type":"object","additionalProperties":{"type":"number"}},
                "setup_cost":    {"type":"object","additionalProperties":{"type":"number"}},
                "min_batch":     {"type":"object","additionalProperties":{"type":"number"}}
            }
        }
    }
}
